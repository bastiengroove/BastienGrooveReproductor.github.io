let playlist = [ {
  'title': 'Bastien Groove - Love (Original Mix)',
  'audio': "assets/Bastien Groove - Love (Original Mix).mp3",
}, {
  'title': 'Bastien Groove - Perro (Original Mix)',
  'audio': "assets/Bastien Groove - Perro (Original Mix) IA.mp3",
}, {
  'title': 'Bastien Groove - Plaza (Original Mix)',
  'audio': "assets/Bastien Groove - Plaza (Original Mix).mp3",
}, {
  'title': 'Bastien Groove - Cekal (Original Mix)',
  'audio': "assets/Bastien Groove - Cekal (Original Mix).mp3",
} ];
i = 0;
n = playlist.length;
